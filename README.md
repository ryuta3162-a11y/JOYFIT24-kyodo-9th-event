...
ランキングは `score1 / score2 / score3` のうち、その人の最高記録です。
...
| 週 | 種目 | 期間 |
|---|---|---|
| 1 | 握力測定 | 2026/8/3 〜 2026/8/8 |
| 2 | 前屈 | 2026/8/9 〜 2026/8/16 |
| 3 | プランク | 2026/8/17 〜 2026/8/23 |
| 4 | 腕立て伏せ | 2026/8/24 〜 2026/8/30 |

日程を変更する場合は、`index.html` と `Code.gs` の両方を揃えて更新し、GASは新バージョンで再デプロイしてください。
...
- ランキングは同じ識別情報の週内記録のうち、最高記録で並べます。
